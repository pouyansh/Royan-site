...
class News(models.Model):
    ...
    description = models.TextField(max_length=2000, default='', verbose_name="متن خبر (فارسی)")
    ...
    english_description = models.TextField(max_length=2000, default='', blank=True, verbose_name="متن خبر (انگلیسی)")
