...
class Paper(models.Model):
    ...
    paper = models.FileField(verbose_name="مقاله", name="paper", null=True, blank=True, default=None)
    link = models.URLField(max_length=128, default=None, null=True, blank=True, verbose_name="لینک")
