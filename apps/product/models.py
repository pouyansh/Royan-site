...
class Category(models.Model):
    name = models.CharField(verbose_name="نام", max_length=400)
    description = models.TextField(verbose_name="توضیحات", max_length=4000)
    is_active = models.BooleanField(default=True)


class Product(models.Model):
    name = models.CharField(verbose_name="نام", max_length=300)
    description = models.TextField(verbose_name="توضیحات", max_length=4000)
